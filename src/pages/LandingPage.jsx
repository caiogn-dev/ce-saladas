...
const PROMO_STORAGE_KEY = 'ce-saladasPromoSeen';
const PROMO_EVENT = 'ce-saladas-promo';

// Contact info from environment variables
const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'contato@ce-saladas.com.br';
...
const INSTAGRAM_URL = process.env.NEXT_PUBLIC_INSTAGRAM_URL || 'https://instagram.com/ce-saladas';
      ...
      {showPromo && (
        <div className="promo-modal-overlay" onClick={handleClosePromo} role="presentation">
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Promoção Cê Saladas 10% OFF"
        ...
        <div className="container hero-container">
          ...
          <div className={`hero-text ${isVisible ? 'animate-in' : ''}`}>
            ...
            <h1 className="hero-title">
              Saladas frescas e <span className="text-gradient">confeitaria</span> artesanal.
            </h1>
            <p className="hero-description">
              Sabor que cuida de você. Saladas nutritivas e doces irresistíveis,
        ...
        <div className="container">
          ...
          <div className="steps-grid">
            <div className="step-card">
              ...
              <h3>Escolha</h3>
              <p>Navegue pelo cardápio e monte sua salada ou escolha seus doces.</p>
            </div>
            ...
            <div className="step-card">
              ...
              <h3>Peça</h3>
              <p>Faça seu pedido online e pague com PIX de forma rápida e segura.</p>
            </div>
            <div className="step-arrow" aria-hidden="true">
              <svg viewBox="0 0 40 16" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M2 8h30" />
            ...
            <div className="step-card">
              ...
              <h3>Receba</h3>
              <p>Retire no local ou receba em casa fresquinho e pronto para saborear.</p>
            </div>
          </div>
        </div>
      </section>

      {/* Por que Cê Saladas Section */}
      <section className="why-ce-saladas">
        <div className="container">
          <div className="section-header">
            <span className="section-eyebrow">Diferenciais</span>
            <h2 className="section-title">Por que escolher Cê Saladas?</h2>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Saladas preparadas com vegetais selecionados diariamente.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">🍰</span>
              <h3>Confeitaria artesanal</h3>
              <p>Doces feitos com amor e ingredientes de qualidade.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">💚</span>
              <h3>Alimentação saudável</h3>
              <p>Opções nutritivas para cuidar da sua saúde.</p>
            </div>
            <div className="feature-card">
              <span className="feature-icon">🚀</span>
      ...
      <section className="cta-section">
        <div className="container">
          <div className="cta-content">
            ...
            <p>Descubra o sabor das nossas saladas frescas e confeitaria artesanal.</p>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-brand">
              <h3>Cê Saladas</h3>
              <p>Saladas frescas e confeitaria artesanal.</p>
              {/* Social Links */}
          ...
          <div className="footer-bottom">
            <p>© 2026 Cê Saladas. Todos os direitos reservados.</p>
